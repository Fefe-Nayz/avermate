...
const fr: Record<string, string> = {
  ...
  "Weight in your average": "Poids dans votre moyenne",
  "What you need next": "Ce qu'il vous faut ensuite",
  "Assessment coverage": "Matières évaluées",
  "Room left on a goal": "Marge sur un objectif",
  "Where your average comes from": "D'où vient votre moyenne",
  "Why your average moved": "Pourquoi votre moyenne a bougé",
  "Where your average could end up": "Où votre moyenne peut finir",
  ...
  // ---------------------------------------------- admin parity rewrite
  "Class placed on hold.": "Classe mise en pause.",
  "Hold lifted.": "Pause levée.",
  "Class deleted.": "Classe supprimée.",
  "Search by name…": "Rechercher par nom…",
  "All states": "Tous les états",
  "No classes match": "Aucune classe ne correspond",
  "Adjust the search or the state filter.":
    "Ajustez la recherche ou le filtre d'état.",
  Low: "Basse",
  High: "Haute",
  Normal: "Normale",
  ...
  Waiting: "En attente",
  Rejected: "Rejeté",
  "Selected feedback items updated.":
    "Les retours sélectionnés ont été mis à jour.",
  "At least one item changed elsewhere. The queue was reloaded.":
    "Au moins un élément a changé ailleurs. La file a été rechargée.",
  "Manual requests and deduplicated automatic errors, with ownership, labels and an auditable internal timeline.":
    "Demandes manuelles et erreurs automatiques dédupliquées, avec responsables, étiquettes et chronologie interne auditable.",
  "Unique items": "Éléments uniques",
  "Search subject, route or opaque digest":
    "Rechercher un sujet, une route ou un condensé opaque",
  "All priorities": "Toutes les priorités",
  "All sources": "Toutes les sources",
  "All assignments": "Toutes les assignations",
  "Label filter": "Filtre d'étiquette",
  "{count} selected": "{count} sélectionnés",
  "Apply status": "Appliquer le statut",
  "Apply priority": "Appliquer la priorité",
  "Apply assignee": "Appliquer l'assigné",
  ...
  "Sanitized route": "Route assainie",
  "Feedback screenshot": "Capture d'écran du retour",
  "Redacted technical context": "Contexte technique expurgé",
  "This item changed elsewhere. The latest version was reloaded.":
    "Cet élément a changé ailleurs. La dernière version a été rechargée.",
  "No labels yet": "Aucune étiquette pour l'instant",
  "Add internal comment": "Ajouter un commentaire interne",
  ...
  Mokattam: "Mokattam",
  Accounts: "Comptes",
  "{count} created in 30 days": "{count} créés en 30 jours",
  "{count} added in 30 days": "{count} ajoutées en 30 jours",
  "Active users": "Utilisateurs actifs",
  "Accounts that recorded a grade in 30 days":
    "Comptes ayant saisi une note en 30 jours",
  "{count} administrator accounts": "{count} comptes administrateurs",
  "Verified email": "E-mail vérifié",
  "{count} verified accounts": "{count} comptes vérifiés",
  "Grade adoption": "Adoption des notes",
  "{count} accounts have recorded a grade":
    "{count} comptes ont saisi une note",
  "Global average": "Moyenne globale",
  "Not enough grade data": "Pas assez de données de notes",
  "{rate} of account averages are at least 10/20":
    "{rate} des moyennes de comptes atteignent au moins 10/20",
  "Grades per account": "Notes par compte",
  "{count} among active accounts": "{count} parmi les comptes actifs",
  "Product health, adoption and account operations.":
    "Santé du produit, adoption et gestion des comptes.",
  ...
  "Most active accounts": "Comptes les plus actifs",
  "Most used subjects": "Matières les plus utilisées",
  "{years} years · {grades} grades · joined {date}":
    "{years} années · {grades} notes · inscrit le {date}",
  "Search accounts, inspect their activity and manage access.":
    "Recherchez des comptes, inspectez leur activité et gérez les accès.",
  "Search by name, email or id…": "Rechercher par nom, e-mail ou id…",
  "Nobody matches.": "Personne ne correspond.",
  "Page {page} of {total} · {count} accounts":
    "Page {page} sur {total} · {count} comptes",
  "The person must still verify their email before using application data.":
    "La personne doit encore vérifier son e-mail avant d'utiliser les données de l'application.",
  "Account created.": "Compte créé.",
  "Role updated.": "Rôle mis à jour.",
  "Account suspended.": "Compte suspendu.",
  "Suspension lifted.": "Suspension levée.",
  "Mokattam unlocked for this account.": "Mokattam débloqué pour ce compte.",
  "Mokattam access removed.": "Accès Mokattam retiré.",
  "Average /20": "Moyenne /20",
  "Best /20": "Meilleure /20",
  "Lowest /20": "Plus basse /20",
  "Expires {date}": "Expire le {date}",
  "No automatic expiry": "Pas d'expiration automatique",
  "Grade activity": "Activité de notes",
  "Lift suspension": "Lever la suspension",
  Reason: "Motif",
  "Explain why this account is suspended":
    "Expliquez pourquoi ce compte est suspendu",
  ...
  "All current sessions are revoked immediately. The reason is shown when access is denied.":
    "Toutes les sessions en cours sont révoquées immédiatement. Le motif est affiché quand l'accès est refusé.",
  "Academic years": "Années scolaires",
  "Recent sessions": "Sessions récentes",
  "Unknown IP": "IP inconnue",
  "Top subjects": "Matières principales",
  ...
  "This permanently deletes the account and all of its years, grades, goals and settings. Type the account id to confirm.":
    "Ceci supprime définitivement le compte et toutes ses années, notes, objectifs et réglages. Saisissez l'id du compte pour confirmer.",
  "Good news": "Bonne nouvelle",
  "Heads up": "À noter",
  Problem: "Problème",
  Info: "Info",
  "Announcement saved.": "Annonce enregistrée.",
  "Announcement updated.": "Annonce mise à jour.",
  "Announcement deleted.": "Annonce supprimée.",
  "Publish immediately or schedule a precise visibility window.":
    "Publiez immédiatement ou planifiez une fenêtre de visibilité précise.",
  "Changes are reflected in the inbox and active banner immediately.":
    "Les changements se reflètent immédiatement dans la boîte de réception et la bannière active.",
  "Only linked members of the selected presets":
    "Seuls les membres liés aux presets sélectionnés",
  "Preset targeting follows active memberships across preset updates. Users who customize their year leave that audience.":
    "Le ciblage par preset suit les adhésions actives au fil des mises à jour. Les utilisateurs qui personnalisent leur année quittent cette audience.",
  "Schedule the start": "Planifier le début",
  "Schedule the end": "Planifier la fin",
  "Remove it automatically at the end date":
    "La retirer automatiquement à la date de fin",
  "Inactive announcements stay as drafts regardless of their schedule.":
    "Les annonces inactives restent des brouillons quel que soit leur calendrier.",
  "Publish or schedule": "Publier ou planifier",
  ...
  "Starts immediately": "Commence immédiatement",
  ...
  "Grade impact": "Impact de la note",
  "Best next action": "Meilleure prochaine action",
  "Class rank": "Classement dans la classe",
  "Gap to class average": "Écart avec la moyenne de la classe",
  "Classmate average": "Moyenne d’un camarade",
  "Friend average": "Moyenne d’un ami",
  "Average with a friend": "Moyenne comparée avec un ami",
  "Subjects with a friend": "Matières comparées avec un ami",
  "Result control band": "Bande de contrôle des résultats",
  "Unusual result": "Résultat inhabituel",
  "Average concentration": "Concentration de la moyenne",
  "Next grade leverage": "Impact de la prochaine note",
