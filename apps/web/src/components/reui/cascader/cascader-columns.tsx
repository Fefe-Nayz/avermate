    ...
    emptyBody = (
      <>
        ...
        <button
          ...
          className="rounded-md px-1 font-medium text-foreground outline-hidden transition-colors hover:bg-accent focus-visible:ring-2 focus-visible:ring-ring/50"
        >
          {labels.retry}
        </button>
      </>
