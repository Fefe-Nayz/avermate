...
const TONE = {
  ...
  success: { icon: CheckCircle2Icon, className: "bg-band-good/12 text-foreground" },
  warning: { icon: AlertTriangleIcon, className: "bg-band-fair/16 text-foreground" },
  danger: { icon: OctagonAlertIcon, className: "bg-destructive/10 text-foreground" },
} as const;
