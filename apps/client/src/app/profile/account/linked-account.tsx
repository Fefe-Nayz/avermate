  ...
  export default function LinkedAccount() {
    ...
    async function handleUnlinkAccount(provider: ProviderId) {
      try {
        ...
        toast.success("Unlinked", { description: `${provider} disconnected.` });
      } catch (error: any) {
  ...
  function ResetPasswordDialog({ children }: { children: React.ReactNode }) {
    ...
    async function onSubmit(e: React.FormEvent) {
      ...
      if (newPassword !== confirm) {
        toast.error("Passwords do not match", { description: "Make sure both passwords are identical." });
        return;
      }
      ...
      try {
        ...
        toast.success("Password updated", { description: "You'll need to sign in again on other devices." });
        setOpen(false);
        setCurrentPassword("");
        setNewPassword("");
        setConfirm("");
