...
| Admin activity         | Admin overview                      | Responsive area chart with browser-fetched data and a default tooltip            | TanStack area/line/dot marks, localized tooltip, and the shared semantic time viewport; data is prefetched on the server and hydrated                                         |
